...
public class MagicMissileLauncher : Skill
{
    ...
    public override void launchProjectile(){
        if(checkCondition()){
            ...
            Projectile p1 = createProjectile();
            p1.setDirect(rot(direction,-(Mathf.PI/24f)));
            Projectile p2 = createProjectile();
            p2.setDirect(rot(direction,(Mathf.PI/24f)));
